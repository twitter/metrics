...
for _org in ALL_ORGS:
    ...
    """
    Add all the projects under the org
    """
    projects = PROJECTS_TRACKED['projects'][org]
    list_of_projects = f'{len(projects)} projects' + '\n'
    list_of_projects += '<ul>' + '\n'
    for project in sorted(projects):
        list_of_projects += '\t' + f'<li><a href="/metrics/{org}/{project}/WEEKLY">{project}</a></li>' + '\n'
    list_of_projects += '</ul>' + '\n'
