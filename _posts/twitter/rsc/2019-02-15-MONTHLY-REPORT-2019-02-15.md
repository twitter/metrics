...
title: Metrics report for twitter/rsc | MONTHLY-REPORT-2019-02-15 | 2019-02-15
permalink: /twitter/rsc/MONTHLY-REPORT-2019-02-15/
...
<table class="table table-condensed" style="border-collapse:collapse;">
    ...
    <tbody>
        ...
        <tr data-toggle="collapse" data-target="#col-openIssues" class="accordion-toggle" style="cursor: pointer;">
            ...
            <td style="color: #d31c08" >21.57%</td>
        </tr>
        ...
        <tr data-toggle="collapse" data-target="#col-closedIssues" class="accordion-toggle" style="cursor: pointer;">
            ...
            <td style="color: #45c527" >19.53%</td>
        </tr>
        ...
        <tr data-toggle="collapse" data-target="#col-pullRequests" class="accordion-toggle" style="cursor: pointer;">
            ...
            <td style="color: #45c527" >35.24%</td>
        </tr>
        ...
        <tr data-toggle="collapse" data-target="#col-mergedPullRequests" class="accordion-toggle" style="cursor: pointer;">
            ...
            <td>98</td>
            <td style="color: #45c527" >37</td>
            <td style="color: #45c527" >37.76%</td>
        </tr>
